...
export const PERMISSIONS = {
  ...
  MANAGE_AMBULANCES: 'ambulances:manage',
  MANAGE_USERS: 'users:manage',
  VIEW_SETTINGS: 'settings:view',
  VIEW_DISPATCH: 'dispatch:view',
  VIEW_FIELD_OFFICER_CONTACTS: 'contacts:field-officers',
...
export const ROLE_PERMISSIONS = {
  ...
  [ROLES.DISPATCHER]: [
    ...
    PERMISSIONS.VIEW_FIELD_OFFICER_CONTACTS,
  ],
  [ROLES.ADMINISTRATOR]: [
    PERMISSIONS.VIEW_DASHBOARD,
    PERMISSIONS.VIEW_INCIDENTS,
...
export const NAVIGATION_ITEMS = [
  ...
  { label: 'Field Officer Contacts', icon: Phone, path: '/admin/contacts', permission: PERMISSIONS.VIEW_FIELD_OFFICER_CONTACTS, group: 'DISPATCH' },
  ...
  { label: 'News Review', icon: Database, path: '/admin/scraper-review', permission: PERMISSIONS.MANAGE_SCRAPER, group: 'TOOLS' },
  { label: 'Location Matching', icon: MapPin, path: '/admin/landmarks', permission: PERMISSIONS.MANAGE_SCRAPER, group: 'TOOLS' },

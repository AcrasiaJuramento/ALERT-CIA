...
export function LegacyPrintablePCR({ record: sourceRecord, printOnly = false }) {
  ...
  return <div className={`pcr-paper ${printOnly ? "pcr-print-source" : "pcr-preview"} text-black bg-white`} data-pcr-export-id={record.id}>
    ...
    <section className="pcr-page">
      ...
      <div className="pcr-grid mt-1" style={{gridTemplateColumns:"2fr .5fr 1fr .7fr 1fr"}}><Cell label="Patient Name" value={record.patientName}/><Cell label="Age" value={record.age}/><Cell label="Birthday" value={formatLongDate(record.birthday, "")}/><Cell label="Gender" value={record.gender}/><Cell label="Civil Status" value={record.civilStatus}/></div>
      ...
      <div className="pcr-grid mt-1" style={{gridTemplateColumns:"1fr 1fr 1fr 1fr"}}><Cell label="Nature of Call" value={record.natureOfCall}/><Cell label="Date of Incident" value={formatLongDate(record.dateOfIncident, "")}/><Cell label="Time of Incident" value={record.timeOfIncident}/><Cell label="Place of Incident" value={record.placeOfIncident}/></div>

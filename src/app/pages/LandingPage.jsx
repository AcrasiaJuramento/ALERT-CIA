    ...
    <div className="min-h-screen bg-slate-950 text-white font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-sm font-bold">ALERT-CIA</span>
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <button onClick={() => navigate('/login')} className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-all">Staff Login</button>
          </div>
        </div>
      </nav>
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-4 leading-tight">
              ALERT<span className="text-red-500">-</span>CIA
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <button onClick={() => navigate('/login')} className="flex items-center gap-2 px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-red-600/25 text-base">
                <Zap className="w-5 h-5" />
                Get Started
                <ChevronRight className="w-5 h-5" />
              </button>
              <button onClick={() => navigate('/public')} className="flex items-center gap-2 px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white font-semibold rounded-xl transition-all border border-slate-700 text-base">
                <Globe className="w-5 h-5" />
                Public Safety View
              </button>
              <button onClick={() => navigate('/public/map')} className="flex items-center gap-2 px-6 py-4 text-slate-300 hover:text-white font-medium transition-colors text-base">
      ...
      <section className="py-20 bg-slate-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-3">Live Emergency Map</h2>
      ...
      <section className="py-20 bg-slate-950">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-2">Everything for Emergency Response</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {modules.map(({ icon: Icon, label, desc, color }) => (
              <div key={label} className="p-6 bg-slate-900 border border-slate-800 rounded-xl hover:border-slate-600 transition-all group cursor-pointer">
      ...
      <section className="py-20 bg-slate-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-8">How ALERT-CIA Works</h2>
          </div>
          <div className="relative">
            <div className="absolute left-1/2 top-0 bottom-0 w-px bg-slate-700 hidden md:block" />
            <div className="space-y-8">
              {steps.map((step, i) => (
                <div key={step.num} className={`flex gap-8 items-center ${i % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                  ...
                  <div className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center shrink-0 border-2 border-slate-900 relative z-10 text-xs font-bold">{i + 1}</div>
      ...
      <section className="py-20 bg-linear-to-br from-red-950/50 via-slate-900 to-blue-950/50">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Strengthen Emergency Response?</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button onClick={() => navigate('/login')} className="flex items-center gap-2 px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-xl transition-all shadow-lg">
              Access System
              <ArrowRight className="w-5 h-5" />
            </button>
            <button onClick={() => navigate('/register')} className="px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white font-semibold rounded-xl border border-slate-700 transition-all">
              Register Account
            </button>
          </div>

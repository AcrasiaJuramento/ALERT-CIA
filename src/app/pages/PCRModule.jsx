...
export default function PCRModule() {
  ...
  useEffect(() => {
    let mounted = true;
    Promise.all([listRespondingTeams(), listAmbulanceUnits(), listCrewMembers()])
  ...
  const selectedTeamId = form.respondingTeamId || teamOptions.find(team => team.name === (form.respondingTeam || form.team))?.id || "";
